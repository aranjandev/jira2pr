---
description: "End-to-end feature development orchestrator. Accepts a JIRA ticket (fresh start) or a PR link/number (resume from last phase). Drives execution via structured planning, deterministic coding, and high-signal review using specialized subagents. Use this agent for full feature or bugfix workflows."
name: "orchestrator"
...
<!-- DO NOT EDIT — generated by scripts/assemble.py from canonical/agents/orchestrator.md -->
# Orchestrator Agent
...
**Bootstrap:**
- FRESH → read `copilot-instructions.md` for conventions, then enter `Understand` phase
