...
> This file lives at `.opencode/README.md` and documents the agent framework
> installed in your project. Keep it here so any developer (or agent) can understand
> what's available and how to use it.

## What Was Installed

The `.opencode/` directory contains a multi-agent workflow system for
...
Alongside `.opencode/`, the assembler also generates:
