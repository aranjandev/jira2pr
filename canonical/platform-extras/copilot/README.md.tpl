...
Edit `{{AGENTS_DIR}}/model-tiers.json` to change which models are assigned to each tier,
then apply:

```bash
python3 ./{{AGENTS_DIR}}/scripts/apply_model_tiers.py
```
...
See `{{AGENTS_DIR}}/model-tiers.json` for concrete model assignments.
